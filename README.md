# Bus Transit & Route Reservation Suite

Robust Django web system designed for managing fleet schedules, bus dispatching, passenger seat allocation, and booking verification.
...
- **Technologies**: Django 4+, SQLite, Bootstrap, Python 3.11
- **Lead Developer**: MASA
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/XREFS0/masa-django-transit-system.git
   cd masa-django-transit-system
   ```
